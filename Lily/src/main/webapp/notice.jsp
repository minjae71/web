...
<%
		...
		count = NoticeMgr.countNotice();
		
		int startRow = (currentPage - 1) * pageSize;
		ArrayList<NoticeBean> list = NoticeMgr.getList(startRow, pageSize);
...
<%
					...
					{
%>
						<div class="write_box"><a href="noticeWrite.jsp">WRITE</a></div>
<%
					}
%>
				</div>
...
%>
									<tr>
										...
										<td><a href="noticeView.jsp?no=<%=list.get(i).getNum()%>"><%=list.get(i).getSubject().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></a></td>
