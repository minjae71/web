...
<body>
	<div class="accordion js-accordion">
		...
		<div class="accordion__item js-accordion-item active">
			...
			<div class="accordion-body js-accordion-body">
				<div class="accordion-body__contents"><a class="header-logout" href="logout.jsp"></a></div>
				<div class="accordion-body__contents"><a class="header-mypage-admin" href="mypage_admin.jsp"></a></div>
				<div class="accordion-body__contents"><a class="header-notice" href="notice.jsp"></a></div>
				<div class="accordion-body__contents"><a class="header-qa" href="qna.jsp" class = "last"></a></div>
