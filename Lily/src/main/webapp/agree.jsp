...
<head>
	...
	<title>약관동의 전체보기</title>
</head>
<body>
	<section>
		<div class="agrW">
			<h4 class="tit" style="margin-top: 30px;">이용약관</h4>
				<div class="privercyCT">
					<textarea cols="80" wrap="virtual" rows="10" readonly>
        인터넷 쇼핑몰 『Lily(주) 사이버 몰』회원 약관

제1조(목적)
이 약관은 Lily(주) 회사(전자상거래 사업자)가 운영하는 Lily(주) 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 Lily(주) 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 Lily(주) 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
“Lily”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.

본 약관은 2021년 11월 04일부터 적용됩니다.
					</textarea>
			</div>
			<h4 class="tit">개인정보 수집·이용</h4>
			<table border="0" summary="구분, 목적, 항목, 보유기간, 필수정보, 선택정보" class="contract-tbl">
				...
				<tbody>
					<tr>
						...
						<td><div class="p10 itemsY">이름, 아이디, 비밀번호, 이메일, 휴대폰, 생일, 성별</div></td>
						<td><div class="p10 holdingY">회원탈퇴 후 즉시</div></td>
					</tr>
					<tr>
						<th scope="row" rowspan="1"><div>선택정보</div></th>
						<td><div class="p10 purpose1">마케팅 활용<br>(이벤트, 맞춤형 광고)</div></td>
						<td><div class="p10 items1">휴대폰, 이메일</div></td>
						<td><div class="p10 holding1">회원탈퇴 후 즉시</div></td>
					</tr>
				</tbody>
			</table>
			<h4 class="tit">개인정보 제3자 제공 (선택)</h4>
			<table border="0" summary="제공받는자, 목적, 항목, 보유기간" class="contract-tbl">
				...
				<tbody>
					<tr>
						<td><div class="pd10 recipient2">CJ대한통운</div></td>
						<td><div class="pd10 purpose2">배송</div></td>
						<td><div class="pd10 items2">이름, 수취인 정보<br>(이름, 휴대전화번호, 주소)</div></td>
						<td><div class="pd10 holding2">3개월</div></td>
					</tr>
				</tbody>
			</table>
			<p class="btm-msg">
